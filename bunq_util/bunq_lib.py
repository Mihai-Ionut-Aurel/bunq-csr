...
class BunqLib(object):
    ...
    def make_payment(self, amount_string, description, recipient):
        ...
        return endpoint.Payment.create(
    ...
    def add_callback_url(self, callback_url):
        ...
        print(json.dumps(all_notification_filter_updated, default=serialize))
        return self.get_current_user().update(
